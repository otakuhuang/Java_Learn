...
public class SimpleShopman implements Shopman {
    ...
    public void serverCustomer(Customer customer) {
        ...
        if (customer instanceof HasCard) {
            ...
            savedMonty = card.processCardDiscount(originCost, finalCost, customer, shoppingCart);
            finalCost -= savedMonty;
        }
        ...
        System.out.println("优惠金额为: " + savedMonty);
        System.out.println("实付金额为: " + moneyEarned);

        // >> TODO 思考题: 上面的代码是否太过复杂了？如果有别的类型的 shopman，是否有代码可以重用？有的话应该怎么做？
    }
}
