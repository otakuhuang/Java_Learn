...
import com.jamhuang.chatroom.common.ChatMessage;
...
import static com.jamhuang.chatroom.common.Constants.*;
import static com.jamhuang.chatroom.common.Utils.isValidUserName;
...
public class ChatRoomServer {
    ...
    private void handleClientSocket(Socket socket) {
        service.submit(new ClientHandle(socket));
    }
    ...
    class ClientHandle implements Runnable {
        ...
        private String getAllNames() {
            ...
            if (name2DataEx.isEmpty()) {
                ...
                return CHAT_WITH_START + ADMIN_NAME + userNameListSep + CHAT_WITH_START + String.join(userNameListSep + CHAT_WITH_START,
                        name2DataEx.keySet());
            }
        }
        ...
        private void initUser(DataExchange dataExchange) {
            ...
            while (true) {
                String allNames = getAllNames();
                dataExchange.send(new ChatMessage(ADMIN_NAME, NO_NAME, (errorMsg == null ? "" : "用户名非法，错误信息为: " + errorMsg + ":") +
                        "现有的用户名为: " + allNames + "。请输入你的用户名: "));
